            ...
            <div className='mt-6 flex flex-col items-start justify-between gap-4 md:flex-row md:items-end'>
              <div>
                ...
                <div className='mt-3 flex flex-wrap items-center gap-3'>
                  ...
                  <span className='inline-flex items-center gap-1.5 rounded-md bg-neutral-700 px-2 py-1 text-sm text-white dark:bg-neutral-800'>
                    <Phone className='h-3.5 w-3.5' /> {student.phoneNumber}
                  </span>
                </div>
              </div>
            </div>
          ...
          <Card className='overflow-hidden border border-neutral-200 bg-white dark:border-neutral-800 dark:bg-neutral-900'>
            <div className='p-6'>
              <div className='flex flex-col gap-4 md:flex-row md:items-center md:gap-6'>
                ...
                <div className='rounded-md bg-emerald-50 px-3 py-1.5 dark:bg-emerald-900/20'>
                  <div className='flex items-center gap-2'>
                    <CheckCircle className='h-4 w-4 text-emerald-600 dark:text-emerald-400' />
                    <span className='text-sm font-medium text-emerald-700 dark:text-emerald-400'>
                      Program Admission Approved
                    </span>
                  </div>
                </div>
              </div>
                        ...
                        <p className='mt-1 text-sm text-neutral-600 dark:text-neutral-400'>
                          {isAdmitted
                            ...
                            : isWaitlisted
                              ...
                              : 'Please contact the Registry office for more information about your application status and alternative funding options.'}
                        </p>
                      </div>
                    </div>
                  </div>
