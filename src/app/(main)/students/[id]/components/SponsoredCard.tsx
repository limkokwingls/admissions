              ...
              <div className='flex-1'>
                ...
                <div className='mt-3 space-y-4'>
                  <p className='text-sm text-neutral-700 dark:text-neutral-300'>
                    Congratulations on your admission! You have been granted
                    both{' '}
                    ...
                    <ol className='mt-2 space-y-3 text-sm'>
                      <li className='flex items-start gap-2'>
                        ...
                        <span className='text-neutral-700 dark:text-neutral-300'>
                          Download your acceptance letter using the button
                          below.
                        </span>
                      </li>
                      <li className='flex items-start gap-2'>
                      ...
                      <li className='flex items-start gap-2'>
                        ...
                        <span className='text-neutral-700 dark:text-neutral-300'>
                          Return the completed acceptance letter along with
                          proof of payment to the Registry office by the
                          deadline.
                        </span>
                      </li>
                    </ol>
                  ...
                  <div className='rounded-md bg-amber-50 p-4 dark:bg-amber-950/30'>
                    ...
                    <p className='mt-2 text-sm text-amber-700 dark:text-amber-300'>
                      Failure to complete these steps by the deadline will
                      result in{' '}
