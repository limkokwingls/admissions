                  ...
                  <ul className='mt-2 space-y-3 text-sm'>
                    <li className='flex items-start gap-2'>
                      ...
                      <span className='text-neutral-700 dark:text-neutral-300'>
                        You have been admitted to the university and can proceed
                        with self-sponsorship. Please review the payment plan
                        below for financing options.
                      </span>
                    </li>
                    <li className='flex items-start gap-2'>
                      <Dot />
                    ...
                    <li className='flex items-start gap-2'>
                      <Dot />
                      <span className='text-neutral-700 dark:text-neutral-300'>
                        The Registry Office will contact you directly by call if
                        a sponsorship opportunity becomes available. Students
                        are strongly advised to explore alternative financing
                        options rather than waiting for possible NMDS
                        sponsorship.
                      </span>
                    </li>
                  </ul>
